...
printf("printf a dongxi :\n");

fscanf(stdin,"%s",tarray[0]);
getchar();
printf("the second donxi:\n");
fscanf(stdin,"%s",tarray[1]);
getchar();

printf("the third donxi:\n");
fscanf(stdin,"%s",tarray[2]);
getchar();
// #strcpy(tarray[0], "bat");
// strcpy(tarray[1], "top");
//strcpy(tarray[2], "xxx");
printf("the current timeis %s\n",__TIME__);
